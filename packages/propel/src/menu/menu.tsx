...
function MenuItem(props: TMenuItemProps) {
  ...
  return (
    <BaseMenu.Item
      disabled={disabled}
      className={cn(
        "w-full cursor-pointer truncate rounded-sm p-1.5 text-left text-secondary outline-none select-none hover:bg-layer-1",
        {
      ...
      <BaseMenu.Portal>
        ...
        >
          <BaseMenu.Popup
            tabIndex={tabIndex}
            className={cn(
              "my-1 min-w-[12rem] overflow-y-scroll rounded-md border-[0.5px] border-strong bg-surface-1 p-2.5 text-11 whitespace-nowrap shadow-raised-200 focus:outline-none",
              {
