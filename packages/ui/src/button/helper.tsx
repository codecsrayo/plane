...
enum buttonIconStyling {
  sm = "size-3 flex justify-center items-center overflow-hidden my-0.5 flex-shrink-0",
  md = "h-3.5 w-3.5 flex justify-center items-center overflow-hidden my-0.5 flex-shrink-0",
  lg = "size-4 flex justify-center items-center overflow-hidden my-0.5 flex-shrink-0",
  xl = "size-4 flex justify-center items-center overflow-hidden my-0.5 flex-shrink-0 ",
}
