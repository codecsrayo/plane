      ...
      const handleFinish = () => {
        ...
        if (col !== dropIndex) {
          ...
          if (isCellSelection(selection)) {
            const selectedTable = findTable(selection);
            if (selectedTable) {
              tr = moveSelectedColumns(editor, selectedTable, selection, dropIndex, tr);
            }
          }
    ...
    <>
      ...
      {isDropdownOpen && (
        <FloatingPortal>
          ...
          />
          <div
            className="max-h-[90vh] w-[12rem] overflow-y-auto rounded-md border-[0.5px] border-strong bg-surface-1 p-2.5 shadow-raised-200"
