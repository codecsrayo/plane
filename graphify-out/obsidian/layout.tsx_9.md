---
source_file: "web/app/(all)/[workspaceSlug]/(projects)/projects/(detail)/archives/layout.tsx"
type: "code"
...
- [[ProjectListLayout()]] - `contains` [EXTRACTED]
- [[ProjectsListHeader()]] - `imports` [EXTRACTED]
- [[ProjectsListMobileHeader]] - `imports` [EXTRACTED]
