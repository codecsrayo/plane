---
source_file: "web/app/(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/intake/layout.tsx"
type: "code"
...
- [[ProjectInboxHeader]] - `imports` [EXTRACTED]
- [[ProjectInboxIssuesLayout()_1]] - `contains` [EXTRACTED]
