...
- [[getAndGroupChildren()]] - `contains` [EXTRACTED]
- [[hasChildrenProperty()]] - `contains` [EXTRACTED]
- [[isAndGroupNode()]] - `contains` [EXTRACTED]
- [[isConditionNode()]] - `contains` [EXTRACTED]
- [[isDateFilterType()]] - `contains` [EXTRACTED]
- [[isGroupNode()]] - `contains` [EXTRACTED]
