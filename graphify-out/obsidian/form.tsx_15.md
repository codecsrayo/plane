---
source_file: "admin/app/(all)/(dashboard)/authentication/github/form.tsx"
type: "code"
...
- [[GithubConfigFormValues]] - `contains` [EXTRACTED]
- [[InstanceGithubConfigForm()]] - `contains` [EXTRACTED]
- [[Props_542]] - `contains` [EXTRACTED]
