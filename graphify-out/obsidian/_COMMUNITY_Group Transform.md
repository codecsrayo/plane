...
- [[replaceNodeInExpression()]] - code - utils/src/rich-filters/operations/manipulation/core.ts
- [[sanitizeAndStabilizeExpression()]] - code - utils/src/rich-filters/operations/transformation/core.ts
- [[shared.ts_5]] - code - utils/src/rich-filters/operations/transformation/shared.ts
- [[shared.ts_6]] - code - utils/src/rich-filters/types/shared.ts
- [[shared.ts_7]] - code - utils/src/rich-filters/validators/shared.ts
- [[shouldUnwrapGroup()]] - code - utils/src/rich-filters/validators/shared.ts
- [[transformExpressionTree()]] - code - utils/src/rich-filters/operations/transformation/core.ts
- [[transformGroup()]] - code - utils/src/rich-filters/operations/transformation/shared.ts
- [[transformGroupWithChildren()]] - code - utils/src/rich-filters/operations/transformation/core.ts
- [[unwrapGroupIfNeeded()]] - code - utils/src/rich-filters/operations/manipulation/core.ts
- [[updateNodeInExpression()]] - code - utils/src/rich-filters/operations/manipulation/core.ts

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Group_Transform
SORT file.name ASC
```
