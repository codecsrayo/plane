---
source_file: "web/app/(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/pages/(list)/layout.tsx"
type: "code"
...
- [[PagesListHeader]] - `imports` [EXTRACTED]
- [[ProjectPagesListLayout()]] - `contains` [EXTRACTED]
