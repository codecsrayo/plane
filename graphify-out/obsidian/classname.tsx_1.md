...
- [[getSupportEmail()_1]] - `contains` [EXTRACTED]
- [[icon-root.tsx]] - `imports_from` [EXTRACTED]
- [[isCustomFontSize()_1]] - `contains` [EXTRACTED]
- [[isCustomTextColor()_1]] - `contains` [EXTRACTED]
- [[isCustomTypography()_1]] - `contains` [EXTRACTED]
