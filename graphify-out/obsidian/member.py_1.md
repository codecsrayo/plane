...
- [[UserProjectRolesEndpoint]] - `contains` [EXTRACTED]
- [[__init__.py_3]] - `imports_from` [EXTRACTED]
- [[base.py_11]] - `imports_from` [EXTRACTED]
- [[create()_13]] - `contains` [EXTRACTED]
- [[destroy()_12]] - `contains` [EXTRACTED]
- [[get()_21]] - `contains` [EXTRACTED]
- [[leave()_1]] - `contains` [EXTRACTED]
- [[list()_12]] - `contains` [EXTRACTED]
- [[partial_update()_10]] - `contains` [EXTRACTED]
