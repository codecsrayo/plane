...
- [[delete-column.ts]] - `imports` [EXTRACTED]
- [[delete-key-shortcut.ts]] - `imports` [EXTRACTED]
- [[delete-row.ts]] - `imports` [EXTRACTED]
- [[drag-handle.tsx_1]] - `imports` [EXTRACTED]
- [[drag-handle.tsx_2]] - `imports` [EXTRACTED]
- [[getSelectedCellPositions()]] - `calls` [EXTRACTED]
- [[getSelectedColumns()]] - `calls` [EXTRACTED]
- [[getSelectedRows()]] - `calls` [EXTRACTED]
