...
- [[Check if the value contains a URL.      This function is protected against ReDoS]] - rationale - api/plane/utils/url.py
...
```dataview
TABLE source_file, type FROM #community/Detects_Accepts
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_Request Intake]]
