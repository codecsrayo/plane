...
- [[test_returns_error_for_unknown_workspace()]] - `contains` [EXTRACTED]
- [[test_returns_error_when_no_admin_found()]] - `contains` [EXTRACTED]
- [[test_saves_installation_id_to_db()]] - `contains` [EXTRACTED]
- [[test_updates_installation_id_on_reinstall()]] - `contains` [EXTRACTED]
