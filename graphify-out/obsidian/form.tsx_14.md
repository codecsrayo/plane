---
source_file: "admin/app/(all)/(dashboard)/authentication/gitlab/form.tsx"
type: "code"
...
- [[GitlabConfigFormValues]] - `contains` [EXTRACTED]
- [[InstanceGitlabConfigForm()]] - `contains` [EXTRACTED]
- [[Props_541]] - `contains` [EXTRACTED]
