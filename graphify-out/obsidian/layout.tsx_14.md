---
source_file: "web/app/(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/modules/(list)/layout.tsx"
type: "code"
...
- [[ModulesListHeader]] - `imports` [EXTRACTED]
- [[ModulesListMobileHeader]] - `imports` [EXTRACTED]
- [[ProjectModulesListLayout()]] - `contains` [EXTRACTED]
