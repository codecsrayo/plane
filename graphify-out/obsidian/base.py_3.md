...
- [[ModuleViewSet]] - `contains` [EXTRACTED]
- [[__init__.py_3]] - `imports_from` [EXTRACTED]
- [[create()_4]] - `contains` [EXTRACTED]
- [[destroy()_5]] - `contains` [EXTRACTED]
- [[get()_8]] - `contains` [EXTRACTED]
- [[list()_6]] - `contains` [EXTRACTED]
- [[partial_update()_5]] - `contains` [EXTRACTED]
