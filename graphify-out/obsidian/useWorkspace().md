...
- [[Invitations()]] - `calls` [EXTRACTED]
- [[StickyInput()]] - `calls` [EXTRACTED]
- [[WorkspaceJoinInvitesStep()]] - `calls` [EXTRACTED]
- [[activity-list.tsx]] - `imports` [EXTRACTED]
- [[authentication-wrapper.tsx]] - `imports` [EXTRACTED]
- [[comment-create.tsx]] - `imports` [EXTRACTED]
- [[core.tsx]] - `imports` [EXTRACTED]
...
- [[usePersonalNavigationPreferences()]] - `calls` [EXTRACTED]
- [[useProjectNavigationPreferences()]] - `calls` [EXTRACTED]
- [[useWorkspaceNavigationPreferences()]] - `calls` [EXTRACTED]
