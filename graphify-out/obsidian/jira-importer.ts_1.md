---
source_file: "packages/types/src/importer/jira-importer.ts"
type: "code"
...
- [[IJiraMetadata]] - `contains` [EXTRACTED]
- [[IJiraResponse]] - `contains` [EXTRACTED]
- [[IJiraResponseAvatarUrls]] - `contains` [EXTRACTED]
