...
```dataview
TABLE source_file, type FROM #community/Load_Apply
SORT file.name ASC
```

## Connections to other communities

- 5 edges to [[_COMMUNITY_Issue Issues]]

## Top bridge nodes

- [[issue_filters.rs]] - degree 19, connects to 1 community
- [[apply_issue_filters()]] - degree 15, connects to 1 community
- [[json_filter_value_to_csv()]] - degree 2, connects to 1 community
