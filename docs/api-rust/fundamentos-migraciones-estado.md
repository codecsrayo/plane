...
|---------|---------------------------|--------|
| `m20260410_000001_baseline` | auth_group, auth_permission, django_*, changelogs, instances, integrations | ✅ |
...
| `m20240101_000004_projects_and_states` | projects, states, labels, estimates, estimate_points, issue_types, project_*, **project_deploy_boards** | ✅ |
| `m20240101_000005_issues_and_modules` | issues, issue_*, cycles, cycle_*, modules, module_*, pages, page_*, draft_issues, draft_issue_* | ✅ |
