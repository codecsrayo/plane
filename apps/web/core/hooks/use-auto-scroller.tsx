...
export const useAutoScroller = (
  ...
  const clearRegisteredTimeout = useCallback(() => {
  ...
  const handleAutoScroll = useCallback(
    ...
    [containerRef, leftOffset, shouldScroll, topOffset]
  );
  ...
  }, [containerRef, handleAutoScroll, onDragEnd, shouldScroll]);
  ...
  }, [clearRegisteredTimeout, containerRef, shouldScroll]);
};
