...
function isMutableRefObject<T>(
  editorReference: React.ForwardedRef<T>
): editorReference is React.MutableRefObject<T | null> {
  return !!editorReference && typeof editorReference === "object" && "current" in editorReference;
}
