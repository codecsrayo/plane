...
const PROJECT_FEATURES_LIST = {
  cycles: {
    ...
    icon: <CycleIcon className="size-5 flex-shrink-0 rotate-180 text-tertiary" />,
    isPro: false,
    isEnabled: true,
  },
  modules: {
  ...
  views: {
    ...
    icon: <ViewsIcon className="size-5 flex-shrink-0 text-tertiary" />,
    isPro: false,
    isEnabled: true,
  },
  pages: {
    ...
    icon: <PageIcon className="size-5 flex-shrink-0 text-tertiary" />,
    isPro: false,
    isEnabled: true,
  },
  inbox: {
    ...
    icon: <IntakeIcon className="size-5 flex-shrink-0 text-tertiary" />,
    isPro: false,
    isEnabled: true,
  },
};
