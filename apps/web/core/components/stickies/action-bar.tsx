    ...
    >
      ...
      >
        <Tooltip tooltipContent="All stickies" isMobile={false} position="left">
          <button
            className="btn btn--icon shadow-sm flex size-10 items-center justify-center rounded-full bg-surface-1"
      ...
      <button
        className={`btn btn--icon shadow-sm flex size-10 items-center justify-center rounded-full bg-surface-1 transition-transform duration-300 ${isExpanded ? "rotate-180" : ""}`}
