...
export const MemberOptions = observer(function MemberOptions(props: Props) {
  ...
  return createPortal(
    <Combobox.Options data-prevent-outside-click static>
      <div
        className={cn(
          "z-30 my-1 w-48 rounded-sm border-[0.5px] border-strong bg-surface-1 p-2.5 text-11 shadow-raised-200 focus:outline-none",
          optionsClassName
        )}
                  ...
                  option && (
                    <Combobox.Option
                      ...
                      className={({ active, selected }) =>
                        cn(
                          "flex w-full items-center justify-between gap-2 truncate rounded-sm p-1.5 select-none",
