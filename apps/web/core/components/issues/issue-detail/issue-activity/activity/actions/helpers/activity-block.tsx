...
export function IssueActivityBlockComponent(props: TIssueActivityBlockComponent) {
  ...
  return (
    ...
    >
      ...
      <div className="z-[4] flex size-7 flex-shrink-0 items-center justify-center overflow-hidden rounded-lg border border-subtle bg-layer-2 text-secondary shadow-raised-100">
