...
export const IssueParentSiblings = observer(function IssueParentSiblings(props: TIssueParentSiblings) {
  ...
  return (
    <div className="my-1">
      {isLoading ? (
        <div className="flex items-center gap-2 p-1 text-left text-11 whitespace-nowrap text-secondary">Loading</div>
        ...
        <div className="flex items-center gap-2 p-1 text-left text-11 whitespace-nowrap text-secondary">
