          ...
          <div className="my-10 flex items-center justify-center p-4 text-center sm:p-0 md:my-20">
            ...
            >
              <Dialog.Panel className="relative flex h-full items-center justify-center">
                <div className="flex h-[61vh] w-full flex-col gap-y-4 overflow-hidden rounded-lg bg-surface-1 p-5 shadow-raised-200 transition-all sm:w-[28rem]">
                  <Dialog.Title as="h3" className="flex justify-between">
                    <span className="text-16 font-medium">Keyboard shortcuts</span>
                    <button type="button" onClick={handleClose}>
                      <CloseIcon className="size-4 text-secondary hover:text-primary" aria-hidden="true" />
                    </button>
                  </Dialog.Title>
