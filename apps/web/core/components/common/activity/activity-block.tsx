...
export function ActivityBlockComponent(props: TActivityBlockComponent) {
  ...
  return (
    ...
    >
      <div className="z-[4] mt-0.5 flex size-7 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-subtle text-secondary shadow-raised-100">
