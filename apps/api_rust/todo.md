...
|---|---------|-------------------|
| 1 | [Objetivo](#objetivo) | Metas de la migración Django → Rust |
| 2 | [plane-live — NO se toca](#plane-live--no-se-toca) | Hocuspocus / Y.js CRDT — permanece Node.js |
| 3 | [ORM: SeaORM](#orm-seaorm) | Justificación de SeaORM vs Diesel |
| 4 | [Migraciones: sea-orm-migration](#migraciones-sea-orm-migration) | Baseline, flujo de migraciones, CI/CD |
| 5 | [Stack completo](#stack-completo) | Tabla de librerías Rust vs equivalente Django |
| 6 | [Arquitectura actual vs futura](#arquitectura-actual-vs-futura--diagrama-de-flujo) | Diagramas Mermaid del stack |
| 7 | [Soft delete](#soft-delete--implementado-) | Trait `SoftDeleteExt` + macro |
| 8 | [Estrategia de migración por fases](#estrategia-de-migración--por-fases) | Fases 0–5 con checklist |
| 9 | [Estado de migraciones](#estado-de-migraciones--seguimiento) | Archivos m001–m006, fixes aplicados |
| 10 | [Población de datos iniciales (seed)](#población-de-datos-iniciales-workspace-seed) | WorkspaceSeedJob apalis + JSON data |
| 11 | [Patrones de diseño y arquitectura](#patrones-de-diseño-y-arquitectura) | Repository, AppState, Extractors, AppError, Jobs, Cron |
| 12 | [Integración en el flujo — diagramas](#integración-en-el-flujo--diagramas-de-secuencia) | Sequence diagrams: workspace seed + auth request |
| 13 | [Cosas críticas a tener en cuenta](#cosas-críticas-a-tener-en-cuenta) | 13 puntos de riesgo operacional |
| 14 | [Estructura completa de archivos](#estructura-completa-de-archivos--estado-objetivo) | Árbol de directorios del proyecto Rust |
| 15 | [Integraciones — GitHub, GitLab, Slack](#integraciones--github-gitlab-slack) | Modelo de datos, endpoints, flujos OAuth, jobs |
| 16 | [Flujo de Workspace Settings](#flujo-de-workspace-settings) | Arquitectura completa del panel de configuración |
