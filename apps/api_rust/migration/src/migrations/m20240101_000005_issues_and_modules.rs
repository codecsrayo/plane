        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("attachments")).custom(Alias::new("character varying(200)[]")).not_null())
                    .col(ColumnDef::new(Alias::new("created_by_id")).uuid().null())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("last_saved_at")).timestamp_with_time_zone().not_null())
                    .col(ColumnDef::new(Alias::new("owned_by_id")).uuid().not_null())
                    .col(ColumnDef::new(Alias::new("assignees")).custom(Alias::new("uuid[]")).not_null())
                    .col(ColumnDef::new(Alias::new("labels")).custom(Alias::new("uuid[]")).not_null())
                    .col(ColumnDef::new(Alias::new("cycle")).uuid().null())
                    .col(ColumnDef::new(Alias::new("modules")).custom(Alias::new("uuid[]")).not_null())
