...
// Alias para legibilidad Ã¢ÂÂ `.active()` filtra `deleted_at IS NULL`
// (implementado via `impl_soft_delete!` en entities/mod.rs)

// Ã¢ÂÂÃ¢ÂÂ DTOs Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

/// RepresentaciÃÂ³n pÃÂºblica del usuario autenticado (`/users/me/`).
...
/// la lÃÂ³gica de redirecciÃÂ³n que consume el SPA al iniciar sesiÃÂ³n.
#[derive(Debug, Serialize, utoipa::ToSchema)]
...
///
/// La shape es asimÃÂ©trica (paridad con Django):
/// - Cuando hay `last_workspace_id` vÃÂ¡lido y membresÃÂ­a activa: se incluyen
...
// Ã¢ÂÂÃ¢ÂÂ Conversiones Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
/// DELETE /api/users/me/ Ã¢ÂÂ desactiva la cuenta del usuario.
#[utoipa::path(
    delete,
    path = "/users/me/",
    tag = "Users",
...
pub async fn deactivate_me(
    ...
    // Verificar que no es el ÃÂºnico admin en algÃÂºn workspace activo
...
/// GET /api/users/session/
///
/// Retorna si el usuario estÃÂ¡ autenticado. No requiere auth.
#[utoipa::path(
    get,
    path = "/users/session/",
    tag = "Users",
...
pub async fn get_settings(
    ...
    // `WorkspaceMemberInvite` hereda de `BaseModel Ã¢ÂÂ AuditModel Ã¢ÂÂ SoftDeleteModel`
    ...
    // Rama 1: hay `last_workspace_id` + membresÃÂ­a activa del user en ese workspace.
    ...
    let workspace = if let Some(ws) = last_workspace {
        // `workspace.logo_asset.asset_url` Ã¢ÂÂ `/api/assets/v2/static/{id}/`
        // Django: `"" ` si no hay asset (string vacÃÂ­o, no None).
        let logo = ws
            .logo_asset_id
        ...
        // Rama 2: sin last_workspace vÃÂ¡lido Ã¢ÂÂ fallback = workspace mÃÂ¡s antiguo
        ...
        // una versiÃÂ³n previa hacÃÂ­a `workspace_members.find().order_by(wm.created_at)
        // .limit(1)` y luego `workspaces.find_by_id(...)`. Ese patrÃÂ³n rompe en dos
        // dimensiones respecto a Django:
        //   1) Si el user tiene una membresÃÂ­a activa en un workspace
        //      soft-deleted MÃÂS ANTIGUO que uno vivo, el LIMIT 1 captura la fila
        //      muerta y el find_by_id posterior devuelve None Ã¢ÂÂ fallback = null.
        //      El ORM de Django filtra `workspaces.deleted_at IS NULL` en el mismo
        //      SELECT antes del LIMIT, asÃÂ­ que el soft-deleted nunca compite.
        //   2) Ordenaba por `workspace_members.created_at`, pero Django ordena por
        //      `workspaces.created_at` Ã¢ÂÂ columnas distintas, valores distintos.
...
pub async fn get_instance_admin(AnyAuth(user): AnyAuth) -> impl IntoResponse {
    // Solo superusers son instance admins en la implementaciÃÂ³n base
...
pub async fn list_user_workspaces(
    ...
    // Obtener membresÃÂ­as activas del usuario
    let memberships = workspace_members::Entity::find()
        .filter(workspace_members::Column::MemberId.eq(user.id))
        .filter(workspace_members::Column::IsActive.eq(true))
        .active()
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ GET /api/users/me/workspaces/{slug}/project-roles Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
//
...
/// el usuario tiene `is_active = true` Y existe membresÃÂ­a activa al
...
pub async fn get_user_project_roles(
    ...
    //
    //    Equivale a: el usuario debe tener una membresÃÂ­a activa AL WORKSPACE
    //    ademÃÂ¡s de a los proyectos. Si no la tiene, devolvemos mapa vacÃÂ­o
    //    (Django retorna {} tambiÃÂ©n porque el queryset queda vacÃÂ­o, no 403).
    ...
    //    asÃÂ­ que el filtro por igualdad ya descarta NULLs.
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ /api/users/me/workspaces/invitations/ (GET + POST) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
//
...
/// Workspace embebido en la respuesta de invitaciÃÂ³n (mirror de
...
pub struct UserInviteWorkspaceLite {
    ...
    /// `logo_asset` (no el campo `logo` legacy) este campo serÃÂ¡ `None` Ã¢ÂÂ
    /// limitaciÃÂ³n aceptable para el flujo de onboarding (no hay UI que
...
pub struct JoinWorkspacesRequest {
    ...
    /// `invitations` que envÃÂ­a el frontend en el POST.
...
pub async fn list_user_workspace_invitations(
    ...
    // por email vacÃÂ­o devuelve queryset vacÃÂ­o).
    ...
    let resp: Vec<UserWorkspaceInviteResponse> = invites
        ...
        .filter_map(|i| {
            ...
            // invitaciÃÂ³n (Django con select_related dejarÃÂ­a workspace=None y
            // el serializer fallarÃÂ­a Ã¢ÂÂ preferimos filtrar silenciosamente).
...
///      con el rol de la invitaciÃÂ³n.
...
/// del usuario autenticado Ã¢ÂÂ defensa contra UUID-guessing.
#[utoipa::path(
    post,
    path = "/api/users/me/workspaces/invitations/",
    tag = "Users",
...
pub async fn join_user_workspace_invitations(
    ...
    // Ã¢ÂÂÃ¢ÂÂ 1. Cargar invitaciones que matchean pk Ã¢ÂÂ payload AND email == user.email
    //
    // El doble filtro (pk + email) es la defensa de Django contra que un
    // usuario acepte la invitaciÃÂ³n de OTRO conociendo su UUID. Crucial
    // mantenerlo en Rust.
    let invites = workspace_member_invites::Entity::find()
        .active()
    ...
    // Ã¢ÂÂÃ¢ÂÂ 2. Reactivar membresÃÂ­as existentes con el rol de la invitaciÃÂ³n.
    //
    // Mirror de:
    ...
    //
    // Iteramos para preservar el `role` por invitaciÃÂ³n (un UPDATE bulk con
    // mismo rol perderÃÂ­a la granularidad).
    for inv in &invites {
    ...
    // Ã¢ÂÂÃ¢ÂÂ 3. Bulk insert de membresÃÂ­as nuevas con ON CONFLICT DO NOTHING.
    //
    // La unique constraint `workspace_member_unique_workspace_member_when_deleted_at_null`
    // cubre (workspace_id, member_id) cuando deleted_at IS NULL Ã¢ÂÂ mirror del
    ...
    workspace_members::Entity::insert_many(new_members)
        .on_conflict(
            ...
            // specification" Ã¢ÂÂ el otro unique existente (unique_together sobre las
    ...
    // Ã¢ÂÂÃ¢ÂÂ 4. Soft-delete de las invitaciones procesadas.
    //
    // Django hace .delete() (con soft delete habilitado a nivel de manager
    // base). Replicamos seteando deleted_at en lugar de DELETE fÃÂ­sico para
...
// proyecto, con paginaciÃÂ³n cursor estilo Django.
//
// A diferencia de `WorkspaceUserActivityEndpoint`:
//   - No filtra por workspace/proyecto (es cross-workspace).
//   - No excluye field in (comment|vote|reaction|draft) Ã¢ÂÂ Django tampoco lo hace
//     en este endpoint (sÃÂ³lo en el workspace-scoped). Ver Django: queryset
//     puro `actor=request.user`.
//   - No requiere membership checks (sÃÂ³lo actividades del propio usuario).
//   - `default_per_page = 1000` (mirror de `BasePaginator.get_per_page`).
//
// Response shape idÃÂ©ntico a `BasePaginator.paginate`, los DTOs de detalle se
...
pub async fn get_my_activities(
    ...
    // Ã¢ÂÂÃ¢ÂÂ Base query Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    // Django: IssueActivity.objects.filter(actor=request.user)
    //
    // SECURITY NOTE: el filtro por `actor_id = auth_user.id` es el ÃÂºnico
    // control de acceso necesario Ã¢ÂÂ un usuario sÃÂ³lo puede ver SUS propias
    ...
    // filtro vÃÂ­a `SoftDeleteManager` a nivel de modelo).
    ...
    // Ã¢ÂÂÃ¢ÂÂ Ordenamiento (default -created_at) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    let ordered = match col {
        ...
        // Cualquier columna no whitelisted Ã¢ÂÂ fallback seguro al default.
        // Esto previene SQL injection vÃÂ­a `order_by` y alinea con el spirit
        // del `BasePaginator` de Django (que sÃÂ³lo acepta columnas del modelo).
        _ => base.order_by_desc(issue_activities::Column::CreatedAt),
    };

    // Ã¢ÂÂÃ¢ÂÂ Fetch de la pÃÂ¡gina Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    ...
    // Ã¢ÂÂÃ¢ÂÂ Batch-fetch de objetos relacionados (evitar N+1) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    //
    ...
    // Issue IDs de la pÃÂ¡gina actual
    ...
    // Workspace IDs Ã¢ÂÂ cross-workspace, por eso batch-fetch (a diferencia del
    ...
    // Ã¢ÂÂÃ¢ÂÂ Ensamblar respuesta Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ GET /users/me/workspaces/{slug}/activity-graph/ Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

/// Actividad del usuario en el workspace agrupada por fecha (ÃÂºltimos 6 meses).
///
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ GET /users/me/workspaces/{slug}/issues-completed-graph/ Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ GET /users/me/workspaces/{slug}/dashboard/ Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

/// Dashboard del usuario: actividad reciente + issues completados + estadÃÂ­sticas.
///
...
pub async fn get_workspace_dashboard(
    ...
    // Ã¢ÂÂÃ¢ÂÂ Actividad reciente (ÃÂºltimos 3 meses) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    #[derive(FromQueryResult)]
    struct ActivityRow {
        created_date: chrono::NaiveDate,
        activity_count: i64,
    ...
    // Ã¢ÂÂÃ¢ÂÂ Issues completados este mes (por semana) Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    #[derive(FromQueryResult)]
    ...
    // Ã¢ÂÂÃ¢ÂÂ Conteos de issues Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    #[derive(FromQueryResult)]
    ...
    // Ã¢ÂÂÃ¢ÂÂ State distribution Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
    #[derive(FromQueryResult)]
...
// Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ GET /users/last-visited-workspace/ Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ

/// Retorna el ÃÂºltimo workspace visitado por el usuario con sus proyectos.
///
