...
pub async fn list_issue_activities(
    ...
    let resp: Vec<ActivityResponse> = activities.iter().map(|a| {
        ...
        ActivityResponse {
            ...
            old_identifier: a.old_identifier.map(|u| u.to_string()),
            new_identifier: a.new_identifier.map(|u| u.to_string()),
            comment: a.comment.clone(), actor_id: a.actor_id, actor_detail,
            issue_id: a.issue_id, issue_comment: a.issue_comment_id.map(|u| u.to_string()),
...
pub async fn get_issue_activity(
    ...
    Ok(Json(ActivityResponse {
        ...
        old_identifier: act.old_identifier.map(|u| u.to_string()),
        new_identifier: act.new_identifier.map(|u| u.to_string()),
        comment: act.comment, actor_id: act.actor_id, actor_detail,
        issue_id: act.issue_id, issue_comment: act.issue_comment_id.map(|u| u.to_string()),
